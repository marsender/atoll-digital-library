...
public:
	...
	*/
	...
	// Moves to the next pair in the enumeration.  <p> Returns true if there is
...
class TermEnum: public CL_NS(util)::RefCount
{
public:
	...
	* greater or equal to <i>target</i>. <p>Returns true if there is such
	* an entry.  <p>Behaves as if written: <pre>
